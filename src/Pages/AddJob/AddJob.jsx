...
const AddJob = () => {
    ...
    return (
        <div className="bg-slate-100 rounded-xl mt-5">
            <h2 className="text-3xl text-center pt-6 font-bold">Post a new job</h2>
            <form onSubmit={handleAddJob} className="card-body">
                ...
                <div className="form-control">
                    ...
                    <input type="text" name="title" placeholder="Job Title" className="input input-primary input-bordered" required />
                </div>
                {/* job location  */}
                ...
                <div className="form-control">
                    ...
                    <input type="text" name="location" placeholder="Job Location" className="input input-primary input-bordered" required />
                ...
                <div className="form-control">
                    ...
                    <select defaultValue="Pick a job type" className="select select-primary w-full max-w-xs">
                ...
                <div className="form-control">
                    ...
                    <select defaultValue="Pick a job Field" className="select select-primary w-full max-w-xs">
               ...
               <div className="form-control">
                    ...
                    <input type="text" name="min" placeholder="Min" className="input input-primary input-bordered" required />
                </div>
                <div className="form-control">
                    
                    <input type="text" name="max" placeholder="Max" className="input input-primary input-bordered" required />
                </div>
                <div className="form-control">
                ...
                <div className="form-control">
                 ...
                 <div className="form-control">
                    ...
                    <input type="text" name="company" placeholder="Company Name" className="input input-primary input-bordered" required />
                </div>
                  {/* job description  */}
                  <div className="form-control">
                    <label className="label">
